...
use crate::iceberg::head_discovery::discover_head;
use crate::iceberg::manifest::Manifest;
...
mod tests {
    ...
    fn test_schema() -> TableSchema {
        TableSchema {
            table_name: "ocs".into(),
            columns: vec![crate::types::schema::ColumnDef {
                name: "id".into(),
                col_type: crate::types::schema::ColumnType::Int64,
                nullable: false,
                ..Default::default()
            }],
            primary_key: vec![0],
